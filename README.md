...
Currently, I contribute to the **[dwrensha/compfiles](https://github.com/dwrensha/compfiles)** project, where I formalize IMO-level challenges to explore the synergy between human architecture and AI-assisted implementation.
